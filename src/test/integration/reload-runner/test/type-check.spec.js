...
describe('Type check', async function(){
    it('should have correct type in QIX', async () => {
        ...
        let connectionId = await app.createConnection({
            ...
            qName: 'jdbc',
            qConnectionString:
            'CUSTOM CONNECT TO "provider=jdbc;driver=postgresql;host=selun-seb1.qliktech.com;port=54321;database=postgres"', // the connection string inclues both the provide to use and parameters to it.
