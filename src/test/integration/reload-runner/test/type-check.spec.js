...
describe('Type check', async () => {
  it('should have correct type in QIX', async () => {
    ...
    const connectionId = await app.createConnection({
      ...
      qName: 'jdbc',
      qConnectionString:
            `CUSTOM CONNECT TO "provider=jdbc;driver=postgresql;host=${host};port=5432;database=postgres"`, // the connection string inclues both the provide to use and parameters to it.
